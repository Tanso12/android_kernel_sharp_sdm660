...
static int __init gf_init(void)
{
	...
	if(((strstr(saved_command_line, "androidboot.fp=gxfp5288_c1n") == NULL) && (strstr(saved_command_line, "androidboot.fp=gxfp3208_b2n") == NULL) && (strstr(saved_command_line, "androidboot.fp=gxfp5288_sd1") == NULL)) || (strstr(saved_command_line,"androidboot.mode=charger") != NULL)) {
